...
<head>
    ...
    <link rel="stylesheet" href="http://localhost/laravel/laravel-tips/ep09/public/style.css">
</head>
<body>
    <header>
        <nav class="navbar navbar-expand-md navbar-dark fixed-top bg-dark">
          ...
          <div class="collapse navbar-collapse" id="navbarCollapse">
            <ul class="navbar-nav mr-auto">
              ...
              <li class="nav-item {{ (Route::current()->getName()==='site.contact'? 'active' : '') }}"><a class="nav-link" href="{{ route("site.contact") }}">Contatos</a></li>
            </ul>
    ...
    <main role="main">
        ...
        <footer class="container">
          ...
          <p>© {{ date('Y') }}, Inc. · <a href="#">Privacy</a> · <a href="#">Terms</a></p>
        </footer>
    </main>
